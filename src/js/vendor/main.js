...
(function($) {
    ...
    $.fn.loading = function() {
        ...
        $(this).each(function() {
            ...
            $target.append('<div class="background"></div><div class="rotate"></div><div class="left"></div><div class="right"></div><div class=""><span>' + opts.percent + 'преподавателей</span></div>');
